...
uint256 hashGenesisBlock("0x00536d24504bac05953fad6c1b944776e9c0d8eb6bbf3174d18381a5f167b335");
static CBigNum bnProofOfWorkLimit = CBigNum().SetCompact(504365644); // Beatcoin: starting difficulty is 1 / 2^12
...
const string strMessageMagic = "Beatcoin Signed Message:\n";
...
{
    // Beatcoin: IsDust() detection disabled, allows any valid dust to be relayed.
...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
    ...
    nSubsidy >>= (nHeight / 840000); // Beatcoin: 840k blocks in ~4 years

    return nSubsidy + nFees;
}

static const int64 nTargetTimespan = 302400; // Beatcoin: 3.5 days
static const int64 nTargetSpacing = 150; // Beatcoin: 2.5 minutes
...
unsigned int static GetNextWorkRequired(const CBlockIndex* pindexLast, const CBlockHeader *pblock)
{
    ...
    // Beatcoin: This fixes an issue where a 51% attack can change difficulty at will.
...
bool CBlock::CheckBlock(CValidationState &state, bool fCheckPOW, bool fCheckMerkleRoot) const
{
    ...
    // Beatcoin: Special short-term limits to avoid 10,000 BDB lock limit:
...
{
    // Beatcoin: temporarily disable v2 block lockin until we are ready for v2 transition
    return false;
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xbd0ffabe302f03137c038425a6b861e5fdef1be270125a71d4b8661aaf5b63c2");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("e413857cf0fbe6376603fa1370b363a64f8a65e1ad90f3fc34ee455b41a6195a64613d43436e89635fff9d19c12b95553fcbfe10ac6a6ac6b205ded348dd67c783") << OP_CHECKSIG;
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime    = 1524276408;
        block.nBits    = 504365644;
        block.nNonce   = 2483091022;

        if (fTestNet)
        {
            block.nTime    = 1524276408;
            block.nNonce   = 1263663296;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0x7c47e0b62c3490f526ca84a2060d984f818d42cfdf4bf16555761fb909629fd5"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0xfb, 0xc0, 0xb6, 0xdb }; // Beatcoin: increase each by adding 2 to bitcoin's value.
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("BeatcoinMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("BeatcoinMiner : ProcessBlock, block not accepted");
    }
